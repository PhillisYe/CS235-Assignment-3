...
TEST_DATA_PATH_MEMORY = os.path.join(os.sep, 'Users', 'yezi', 'CS235-Assignment-3', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join(os.sep, 'Users', 'yezi', 'CS235-Assignment-3', 'tests', 'data', 'database')
